    ...
    script.innerHTML = `
      ...
      window.initEditorBridge = function() {
        ...
        waitForReactComponents().then(() => {
          console.log('🔍 Mobile Editor bridge starting element detection...');
          ...
          console.log('🔍 [mobile bridge] Raw candidates found:', elements.length);
          console.log('🔍 [mobile bridge] First 5 elements:', Array.from(elements).slice(0, 5));
          
          let editableCount = 0;
          
          elements.forEach((element, index) => {
            console.log('🔍 Processing mobile element', index, ':', element.tagName, element.textContent?.substring(0, 50));
            ...
            if (element.closest('[contenteditable="false"]') || 
              ...
              console.log('❌ Skipped mobile element', index, '- matches exclusion criteria');
              return;
            }
            
            console.log('✅ Making mobile element', index, 'editable:', element.tagName);

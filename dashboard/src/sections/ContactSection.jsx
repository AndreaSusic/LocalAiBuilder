...
export default function ContactSection() {
  ...
  // Parse services to extract individual products/services, include user products
  let servicesList = [];
  
  // First, add user products if available
        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <div className="footer-social">
              {/* Only show Facebook since that's the provided profile link */}
              <a href="https://www.facebook.com/profile.php?id=61575620207791" className="icon" target="_blank" rel="noopener noreferrer">

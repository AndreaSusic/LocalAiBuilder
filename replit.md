...
- June 26, 2025: Fixed React dashboard with working Vite configuration - restored specific allowedHosts array with user's Replit domain and wildcard patterns, configured HMR with protocol 'wss' and clientPort 443, dashboard running on port 3001 with mobile-first design using Headless UI for overlay dialogs, includes versions panel and chat interface with full-screen preview functionality

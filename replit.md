...
- June 25, 2025: Switched visibility toggles from hidden attribute to CSS classes - replaced all element.hidden usage with classList.add/remove('hidden'), added .hidden { display: none !important; } CSS rule, updated font picker visibility logic throughout chat.js and script.js to use consistent CSS class-based approach for better performance and maintainability

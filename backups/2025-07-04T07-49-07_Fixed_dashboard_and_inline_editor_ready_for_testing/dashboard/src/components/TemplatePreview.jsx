...
export default function TemplatePreview({ previewId, fallbackBootstrap }) {
    ...
    const fetchPreviewData = async () => {
      try {
        ...
        if (response.ok) {
          ...
          console.log(
            "✅ Loaded cached preview data for:",
  ...
  console.log(
    "🎨 Rendering template with data for:",
    templateData?.company_name || "Unknown Company",
  );
  console.log(
    "📋 TemplatePreview about to render HomepageV1 with bootstrap:",
    !!templateData,
  );
